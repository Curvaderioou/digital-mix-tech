...
function formularioEnviado(resposta) {
  if (resposta.ok) {
    ...
    formulario.innerHTML =
      "<p class='font-2-l' style='grid-column: 1/-1; padding: 1rem; border-radius: 4px; color: #262626; background: #fff;'><span style='color: #E00000;'>Erro no envio</span>, você pode enviar diretamente para o nosso email em: atendimento@digitalmix.tech</p>";
  }
}
